...
La estructura que a mí me ha funcionado, y que he visto en proyectos cada vez más grandes, es bastante simple: dividir todo en dos carpetas principales, `features` y `shared`.
